...
se1_3pe <- CreateSeuratObject(set1.3pe$`Gene Expression`, 'Healthy_Donor_3pe_PBMC_10k',  min.cells = 3, min.features = 200)
se2_3pe <- CreateSeuratObject(set2.3pe$`Gene Expression`, 'Healthy_Donor2_3pe_PBMC_10k_2S',  min.cells = 3, min.features = 200)
se3_3pe <- CreateSeuratObject(set3.3pe, 'Healthy_Donor3_3pe_PBMC_5k',  min.cells = 3, min.features = 200)
se4_3pe <- CreateSeuratObject(set4.3pe$`Gene Expression`, 'Healthy_Donor4_3pe_PBMC_10k_2S',  min.cells = 3, min.features = 200)
se5_3pe <- CreateSeuratObject(set5.3pe, 'Healthy_Donor5_3pe_PBMC_8k',  min.cells = 3, min.features = 200)

se1_5pe <- CreateSeuratObject(set1.5pe$`Gene Expression`, 'Healthy_Donor_5pe_PBMC_10k',  min.cells = 3, min.features = 200)
se2_5pe <- CreateSeuratObject(set2.5pe, 'Healthy_Donor2_5pe_Tcell_1k',  min.cells = 3, min.features = 200)
se3_5pe <- CreateSeuratObject(set3.5pe$`Gene Expression`, 'Healthy_Donor3_5pe_PBMC_10k',  min.cells = 3, min.features = 200)
se4_5pe <- CreateSeuratObject(set4.5pe$`Gene Expression`, 'Healthy_Donor4_5pe_PBMC_1k',  min.cells = 3, min.features = 200)
se5_5pe <- CreateSeuratObject(set5.5pe$`Gene Expression`, 'Healthy_Donor5_5pe_PBMC_10k',  min.cells = 3, min.features = 200)
```
