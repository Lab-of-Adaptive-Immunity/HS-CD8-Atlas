...
ggsave(file="Manuscript_Figures/Atlas_1_with_MAIT_Clustering.svg", plot=p_clust, width=10, height=10)
ggsave(file="Manuscript_Figures/Atlas_1_with_MAIT_Clustering_Optics.svg", plot=p_clust_opt, width=10, height=10)
ggsave(file="Manuscript_Figures/Atlas_1_with_MAIT_Klrb1.svg", plot=p_klrb1, width=10, height=10)
ggsave(file="Manuscript_Figures/Atlas_1_with_MAIT_invariants.svg", plot=p_MAIT_invariants, width=10, height=10)

ggsave(file="Manuscript_Figures/Atlas_1_no_MAIT_Clustering.svg", plot=p_clust_nm , width=10, height=10)
ggsave(file="Manuscript_Figures/Atlas_1_no_MAIT_Clustering_Optics.svg", plot=p_clust_nm_opt, width=10, height=10)
ggsave(file="Manuscript_Figures/Atlas_1_no_MAIT_Ifitm3.svg", plot=p_ifitm3, width=10, height=10)
ggsave(file="Manuscript_Figures/Atlas_1_no_MAIT_Il17r.svg", plot=p_il7r, width=10, height=10)
ggsave(file="Manuscript_Figures/Atlas_1_no_MAIT_Klrd1.svg", plot=p_klrd1, width=10, height=10)
ggsave(file="Manuscript_Figures/Atlas_1_no_MAIT_Sell.svg", plot=p_sell, width=10, height=10)
ggsave(file="Manuscript_Figures/Atlas_1_no_MAIT_Cd27.svg", plot=p_cd27, width=10, height=10)
ggsave(file="Manuscript_Figures/Atlas_1_no_MAIT_Cd28.svg", plot=p_cd28, width=10, height=10)
ggsave(file="Manuscript_Figures/Atlas_1_no_MAIT_Cd95.svg", plot=p_cd95, width=10, height=10)
ggsave(file="Manuscript_Figures/Atlas_1_no_MAIT_Ccr7.svg", plot=p_ccr7, width=10, height=10)
ggsave(file="Manuscript_Figures/Atlas_1_no_MAIT_Cd122.svg", plot=p_cd122, width=10, height=10)
ggsave(file="Manuscript_Figures/Atlas_1_no_MAIT_Gzma.svg", plot=p_gzma, width=10, height=10)
ggsave(file="Manuscript_Figures/Atlas_1_no_MAIT_Gzmb.svg", plot=p_gzmb, width=10, height=10)
ggsave(file="Manuscript_Figures/Atlas_1_no_MAIT_Gzmk.svg", plot=p_gzmk, width=10, height=10)
ggsave(file="Manuscript_Figures/Atlas_1_no_MAIT_Gnly.svg", plot=p_gnly, width=10, height=10)
ggsave(file="Manuscript_Figures/Atlas_1_no_MAIT_Cd7.svg", plot=p_cd7, width=10, height=10)
ggsave(file="Manuscript_Figures/Atlas_1_no_MAIT_Cd45ra.svg", plot=p_cd45ra, width=10, height=10)
ggsave(file="Manuscript_Figures/Atlas_1_no_MAIT_Cd45ro.svg", plot=p_cd45ro, width=10, height=10)
ggsave(file="Manuscript_Figures/Atlas_1_no_MAIT_Cd8a.svg", plot=p_cd8a, width=10, height=10)
ggsave(file="Manuscript_Figures/Atlas_1_no_MAIT_Clones.svg", plot=clone_plot, width=11, height=10)
ggsave(file="Manuscript_Figures/Atlas_1_no_MAIT_Clones_rep.svg", plot=clone_plot_rep, width=10, height=10)
ggsave(file="Manuscript_Figures/Atlas_1_no_MAIT_Clones_other.svg", plot=clone_plot_oth, width=10, height=10)